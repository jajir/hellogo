module github.com/jajir/hellogo/example/print
...
require (
	...
	github.com/jajir/hellogo/example/readsvg v0.0.0-00010101000000-000000000000 // indirect
...
replace github.com/jajir/hellogo/example/readsvg => ../readsvg
